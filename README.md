...
An XGBoost model trained on TF-IDF vectors appears to be the most promising strategy for this relatively small dataset, especially given that more complex neural networks trained on vector embeddings result in overfitting.    
