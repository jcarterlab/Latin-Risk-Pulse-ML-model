...
## The data 🛢
### The 1st dataset
An initial dataset of over 100,000 headlines was collected by scraping headline text from online news sources in Argentina, Brazil, Colombia and Mexico. The texts were then filtered by being put through a keyword matching process before being fed to Google Gemini for labelling.   
