...
Taking a balanced sample from each risk type (political, security and economic) improves overall accuracy, likely because the model is better able to distinguish between previously underrepresented risk types and non-risks.  
