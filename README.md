...
Taking a balanced sample from each risk type (political, security and economic) does not seem to improves overall accuracy, perhaps because the risk types are not that imbalanced or since we are dropping badly needed data.  
